...
Each PoC is intentionally scoped to validate a single architectural idea,
not to build a full product.
...
closed, extractive use is not the goal of this project.
